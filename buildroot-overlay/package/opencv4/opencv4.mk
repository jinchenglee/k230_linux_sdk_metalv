...
#OPENCV4_CONF_OPTS += -DBUILD_CSI_CV=ON -DCORE=C908V
# CSI-CV configuration: Only enable for RISC-V Vector (RVV) builds
# CSI-CV library (libcsi_cv_c908v.a) is compiled with RVV instructions
# and will cause illegal instruction errors on non-vector CPUs
# Vector build - enable CSI-CV with C908V core
OPENCV4_CONF_OPTS += -DBUILD_CSI_CV=ON -DCORE=C908V -DCV_ENABLE_INTRINSICS=OFF
...
# Non-vector build - disable CSI-CV to avoid RVV instructions
OPENCV4_CONF_OPTS += -DBUILD_CSI_CV=OFF -DCV_ENABLE_INTRINSICS=OFF
OPENCV4_CONF_OPTS +=    -DCMAKE_C_FLAGS="-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O2 -g0 -D_FORTIFY_SOURCE=1 -mcpu=c908 -mabi=lp64d  -mtune=c908 "
OPENCV4_CONF_OPTS +=  -DCMAKE_CXX_FLAGS="-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O2 -g0 -D_FORTIFY_SOURCE=1 -mcpu=c908 -mabi=lp64d  -mtune=c908 "
endif
